...
LIS lis;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label footer = new Label("Done By Saeed Kalloub | COMP334 Algorithms Analaysis | 1201-term");
        footer.setTextFill(Color.WHITE);
        footer.setFont(Font.font("Verdana"));
        footer.setFont(Font.font(15));
        footer.setLayoutX(34);
        footer.setLayoutY(366);
        ...
        mainPane.getChildren().addAll(barTop,barBottom,header,footer, SwitchesNumber,BulbsOrder, LoadData);
        mainPane.getChildren().addAll(SwitchesNum, bulbsOrder, FilePath,RUN,Browse, Results,Tables,Simulation);
    ...
    public void ShowSimulationStage() throws FileNotFoundException {
        ...
        bulbs.setSpacing(30);
        Image bulbOff = new Image(new FileInputStream("bulbOff.png"));
        Image bulbOn = new Image(new FileInputStream("bulbOn.png"));
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            nums[i].setTextFill(Color.WHITE);
        ...
        Image ONSwitch = new Image(new FileInputStream("OnSwitch.png"));
        Image OffSwitch = new Image(new FileInputStream("OffSwitch.png"));
...
String l = "LIS : ";
        for (int i = 0; i <lis.LCS.length-1; i++) {
            l = l + lis.LCS[i]+"  |  ";
        }
        l = l+lis.LCS[lis.LCS.length-1];
        Lis.setTextFill(Color.BLACK);
        Lis.setText(l);
